...
class DmSettingsPage extends ConsumerWidget {
  const DmSettingsPage({super.key, required this.currentValue});
          ...
          ...options.map((option) {
            ...
            return ListTile(
              ...
              onTap: () async {
                ...
                if (uid == null) return;
                await FirestoreService().updateUser(uid, {'dmSetting': option.$1});
